# python3.8
"""Contains the implementation of generator described in BerfScene."""

import torch
import torch.nn as nn
from models.utils.unet import Generator 
...
class BerfScene3DGenerator(nn.Module):
    ...
    def __init__(
            ...
            not_use_vae,
            norm_G='spectralspadeinstance1x1',
            interpolate_sr=False,
            segmask=False,
            xyz_pe=False,
            reverse_xy=True,
            hidden_dim=64,
            additional_layer_num=2,
            block_num=4,
            layer_num=2, 
            ff_input=True,
            ...
            mapping_kwargs={},      # Arguments for Mapping Network.
        ...
        self.backbone = Generator(z_dim, c_dim, w_dim, img_resolution=bev_resolution, img_channels=32, label_nc=semantic_nc, use_sel=True, sel_type=sel_type, mapping_kwargs=mapping_kwargs, ff_input=ff_input, block_num=block_num, layer_num=layer_num,  **synthesis_kwargs)
