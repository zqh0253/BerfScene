...
if [[ $# -lt 2 ]]; then
    ...
    echo "    On machine 0: MASTER_IP=node_0_ip MASTER_PORT=node_0_port" \
         "NODE_SIZE=2 NODE_RANK=0 $0 8 stylegan2 [--help]"
    echo "    On machine 1: MASTER_IP=node_0_ip MASTER_PORT=node_0_port" \
         "NODE_SIZE=2 NODE_RANK=1 $0 8 stylegan2 [--help]"
    echo
...
#ossutil64 cp oss://antsys-vilab/softwares/wheels/torchvision-0.12.0+cu113-cp38-cp38-linux_x86_64.whl ./
